...
def test_format_week_embed_1() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Banette (M+5MSC-1APU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
...
def test_format_week_embed_2() -> None:
    ...
    expected.add_field(
        inline=False,
        name="Daily",
        value="- DruddigonPachirisuSigilyphTropiusFarfetch'd "
...
def test_format_week_embed_3() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Garchomp (MSDDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        inline=False,
        name="Daily",
        value="- SpiritombGirafarigKecleonShuckleRelicanth "
        "[Coin x100 50.0% / Coin x300 12.5% / Coin x2000 3.125%]",
    )
...
def test_format_week_embed_5() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Steelix (MSDDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        inline=False,
        name="Daily",
        value="- SeviperWynautTorkoalZangooseLuvdisc "
        "[Coin x100 50.0% / Coin x300 12.5% / Coin x2000 3.125%]",
    )
...
def test_format_week_embed_6() -> None:
    ...
    expected.add_field(
        inline=False,
        name="Daily",
        value="- MaractusDunsparceQwilfishDurantHeatmor "
        "[Coin x100 50.0% / Coin x300 12.5% / Coin x2000 3.125%]",
    )
...
def test_format_week_embed_7() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Manectric (MSC-1APU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        inline=False,
        name="Daily",
        value="- LunatoneTyrogueCastformMantykeSolrock "
        "[Coin x100 50.0% / Coin x300 12.5% / Coin x2000 3.125%]",
    )
...
def test_format_week_embed_9() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Gyarados (MSDDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        inline=False,
        name="Safari",
        value="- Salandit (20.00%), Togedemaru (6.67%), Roggenrola (16.67%), Boldore (10.00%), "
        "Gigalith (3.33%), Rockruff (6.67%), Geodude (Alola Form) (16.67%), "
    ...
    expected.add_field(
        ...
        "WishiwashiKomalaFomantisTorracat [Coin x100 50.0% / Coin x300 12.5% / Coin x2000 3.125%]",
    )
...
def test_format_week_embed_11() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Alakazam (M+5C-1DDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        ...
        "PyukumukuOricorio (Sensu Style)"
        "MudbrayDartrix [Coin x100 50.0% / Coin x300 12.5% / Coin x2000 3.125%]",
    )
...
def test_format_week_embed_13() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Pinsir (M+5DDMSAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
...
def test_format_week_embed_15() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Camerupt (MSDDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        ...
        "Hippowdon (Female) (3.33%), Pidove (20.00%), Tranquill (10.00%), Unfezant (Male) (6.67%), "
        "Unfezant (Female) (3.33%), Jangmo-o (13.33%), Hakamo-o (6.67%) "
        "[EBS 25.0% / EBM 3.125% / EBL 1.5625%]",
    )
    expected.add_field(
        inline=False,
...
def test_format_week_embed_17() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Beedrill (MSC-1APU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
...
def test_format_week_embed_18() -> None:
    ...
    expected.add_field(
        ...
        "Unown (I) (10.00%), Unown (C) (10.00%), Unown (E) (10.00%), Cherubi (Winking) (10.00%), "
        "Cherrim (Winking) (3.33%) [EBS 25.0% / EBM 3.125% / EBL 1.5625%]",
    )
    expected.add_field(
        inline=False,
        name="One Chance a Day!",
...
def test_format_week_embed_19() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Houndoom (DDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
...
def test_format_week_embed_21() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Gardevoir (MSDDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        ...
        "Cottonee (Winking) (16.67%), Whimsicott (Winking) (6.67%), Flabébé (Winking) (13.33%), "
        "Floette (Winking) (6.67%), Snubbull (Winking) (6.67%), Chansey (Winking) (3.33%), "
        "Cutiefly (16.67%) [EBS 25.0% / EBM 3.125% / EBL 1.5625%]",
    )
    expected.add_field(
        inline=False,
        name="One Chance a Day!",
...
def test_format_week_embed_23() -> None:
    ...
    expected.add_field(
        inline=False, name="Competitive Stage", value="- Mega Charizard X (C-1DDAPU)"
    )
    expected.add_field(
        inline=False,
        name="Challenges",
    ...
    expected.add_field(
        ...
        "Jumpluff (Winking) (3.33%), Vulpix (Alola Form) (3.33%), Snorunt (Winking) (10.00%), "
        "Glalie (Winking) (3.33%) [EBS 25.0% / EBM 3.125% / EBL 1.5625%]",
    )
    expected.add_field(
        inline=False,
        name="One Chance a Day!",
...
def test_format_week_embed_24() -> None:
    ...
    expected.add_field(
        inline=False,
        name="Challenges",
        value="- Hoopa (Hoopa Unbound) [PSB 25.0% / PSB 25.0% / RML 1.5625%] (Coin x300)\n"
